...
// CreateCourse displays a course creation form
...
// InsertCourse saves a new course
...
// EditCourse displays a course editing form
func EditCourse(w http.ResponseWriter, r *http.Request) {
	id := r.URL.Query().Get("id")

	c, teachers, err := courseRepository.GetCourseAndTeachers(id)
	if err != nil {
		http.Error(w, err.Error(), 500)
		return
	}
